...
const HomeScreen = () => {
    ...
    const openGoogleMaps = () => {
        if (loadingDepartment === true) {
            console.error('Fehler beim Öffnen von Google Maps Loading');
            return 'load ...';
        } else if (loadErrorDepartment === true || departmentInfo === null) {
            console.error('Fehler beim Öffnen von Google Error');
            return 'error';
        } else {
    ...
    const handleCall = () => {
        if (emergencyInfo?.police) {
            Linking.openURL(`tel:${emergencyInfo.police}`);
        }
    };
    ...
    return (
        <View style={styles.screenContainer}>
            ...
            <View style={styles.headerBar}>
                ...
                <Text style={styles.headerTitle}>Polizei</Text>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.row}>
                    <Text style={styles.label}>Nummer: {emergencyInfo?.police ?? '...'}</Text>
