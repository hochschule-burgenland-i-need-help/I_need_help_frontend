...
describe("PersonalDataScreen", () => {
  ...
  it("shows error on invalid name input", () => {
    ...
    expect(getByTestId("errorName")).toHaveTextContent(
  ...
  it("shows error on invalid age input", () => {
    ...
    expect(getByTestId("errorAge")).toHaveTextContent(
  ...
  it("shows error on invalid weight input", () => {
    ...
    expect(getByTestId("errorWeight")).toHaveTextContent(
  ...
  it("shows error on empty blood group", () => {
    ...
    expect(getByTestId("errorBloodGroup")).toHaveTextContent(
      "Bitte wähle eine Blutgruppe aus."
    );
  });
